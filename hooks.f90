...
subroutine asyncio_hook_write_default_unit_default_format() bind(C)
  implicit none
  write(*,*) 'hook_write'
end subroutine asyncio_hook_write_default_unit_default_format

subroutine asyncio_hook_write_default_unit_formatted(flen, frmt) bind(C)
  use iso_c_binding
  implicit none
...
subroutine asyncio_hook_write_unit_default_format(unt) bind(C)
  use iso_c_binding
  implicit none
  integer(c_int), value :: unt
  write(unt,*) 'hook_write'
